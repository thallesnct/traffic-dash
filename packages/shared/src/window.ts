...
export function resolveWindow(window: Window, today: Date = new Date()): WindowResult {
...
export function resolvePreviousWindow(window: Window, today: Date = new Date()): WindowResult {
